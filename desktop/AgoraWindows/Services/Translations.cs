...
public static class Translations
{
    ...
    private static readonly Dictionary<string, Dictionary<string, string>> Dict = new()
    {
        ["en"] = new()
        {
            ...
            ["feed.subtitle"] = "Your activity feed",
            ["teams.subtitle"] = "Select a team",
            ["calendar.subtitle"] = "Upcoming events",
            ["ctx.reply"] = "Reply",
            ["ctx.edit"] = "Edit",
            ["ctx.delete"] = "Delete",
            ["ctx.delete_confirm"] = "Delete this message?",
        ...
        ["de"] = new()
        {
            ...
            ["feed.subtitle"] = "Dein Aktivitaets-Feed",
            ["teams.subtitle"] = "Waehle ein Team",
            ["calendar.subtitle"] = "Kommende Ereignisse",
            ["ctx.reply"] = "Antworten",
            ["ctx.edit"] = "Bearbeiten",
            ["ctx.delete"] = "Loeschen",
            ["ctx.delete_confirm"] = "Diese Nachricht loeschen?",
